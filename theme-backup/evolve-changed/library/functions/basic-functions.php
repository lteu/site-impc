...
if ($evolve_bootstrap_slide_1 == "1") {
      ...
      $evolve_bootstrap_slide1_button = evolve_get_option('evl_bootstrap_slide1_button','<a class="button" href="#">更多</a>');if ($evolve_bootstrap_slide1_button === false) $evolve_bootstrap_slide1_button = '';
