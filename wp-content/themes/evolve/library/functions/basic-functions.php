...
if ($evolve_bootstrap_slide_1 == "1") {
      ...
      $evolve_bootstrap_slide1_title = evolve_get_option('evl_bootstrap_slide1_title','欧洲华人精英协会意大利分区');if ($evolve_bootstrap_slide1_title === false) $evolve_bootstrap_slide1_title = '';   
      $evolve_bootstrap_slide1_desc = evolve_get_option('evl_bootstrap_slide1_desc','强大的团体，力量型的精英，杰出的成果。。。');if ($evolve_bootstrap_slide1_desc === false) $evolve_bootstrap_slide1_desc = '';
      $evolve_bootstrap_slide1_button = evolve_get_option('evl_bootstrap_slide1_button','<a class="button" href="#">了解更多</a>');if ($evolve_bootstrap_slide1_button === false) $evolve_bootstrap_slide1_button = '';
...
if ($evolve_slide_1 == "1") {
      ...
      $evolve_slide1_title = evolve_get_option('evl_slide1_title','欧洲华人精英协会意大利分区');if ($evolve_slide1_title === false) $evolve_slide1_title = '';   
